...
from custom_components.padspan_ha.ws_settings import _AUTOMORPH_STYLES, _SHOWCASE_THEMES

_ISO = (Path(__file__).resolve().parents[1] / "custom_components" / "padspan_ha"
        / "www" / "padspan-ha" / "views" / "iso_lights.js")
